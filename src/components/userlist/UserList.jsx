...
const UserList = ({ users, selectedUser, setSelectedUser, setUsers }) => {
    ...
    return (
        <div ref={listRef} className=" fixed top-50 left-12 ml-3 rounded-3xl  w-40 h-56  bg-white text-black flex flex-col justify-center items-center border-red-900 border-3 ">
